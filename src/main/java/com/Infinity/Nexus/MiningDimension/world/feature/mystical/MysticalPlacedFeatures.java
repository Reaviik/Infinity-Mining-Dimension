...
public class MysticalPlacedFeatures {
 ...
 public static final Holder<PlacedFeature> MYSTICAL_NETHER_PROSPERITY = PlacementUtils.register("imd_mystical_nether_prosperity", MysticalConfiguredFeatures.NETHER_PROSPERITY_ORE, ModOrePlacement.commonOrePlacement(MysticalCommonConfigs.NETHER_PROSPERITY_VEINS.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMinY), VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMaxY))));
 public static final Holder<PlacedFeature> MYSTICAL_NETHER_SOULSTONE = PlacementUtils.register("imd_mystical_nether_soulstone", MysticalConfiguredFeatures.NETHER_SOULSTONE_ORE, ModOrePlacement.commonOrePlacement(MysticalCommonConfigs.NETHER_SOULSTONE_VEINS.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMinY), VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMaxY))));
 public static final Holder<PlacedFeature> MYSTICAL_NETHER_SOULIUM = PlacementUtils.register("imd_mystical_nether_soulium", MysticalConfiguredFeatures.NETHER_SOULIUM_ORE, ModOrePlacement.commonOrePlacement(MysticalCommonConfigs.NETHER_SOULIUM_VEINS.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMinY), VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMaxY))));
 public static final Holder<PlacedFeature> MYSTICAL_NETHER_INFERIUM = PlacementUtils.register("imd_mystical_nether_inferium", MysticalConfiguredFeatures.NETHER_INFERIUM_ORE, ModOrePlacement.commonOrePlacement(MysticalCommonConfigs.NETHER_INFERIUM_VEINS.get(), HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMinY), VerticalAnchor.aboveBottom(ModPlacedFeatures.netherrackMaxY))));
