...
import com.Infinity.Nexus.MiningDimension.config.MiscCommonConfigs;
...
public class MiscConfiguredFeatures {
    ...
    //Occultism
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> OCCULTISM_SILVER_ORE = FeatureUtils.register("imd_occultism_silver_ore", Feature.ORE, new OreConfiguration(MiscReplaceables.OCCULTISM_SILVER_ORE_REPLACEABLES, MiscCommonConfigs.OCCULTISM_SILVER_SIZE.get()));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> OCCULTISM_DEEPSLATE_SILVER_ORE = FeatureUtils.register("imd_occultism_deepslate_silver_ore", Feature.ORE, new OreConfiguration(MiscReplaceables.OCCULTISM_DEEPSLATE_SILVER_ORE_REPLACEABLES, MiscCommonConfigs.OCCULTISM_DEEPSLATE_SILVER_SIZE.get()));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> OCCULTISM_NETHER_NATURAL_IESNIUM_ORE = FeatureUtils.register("imd_occultism_nether_natural_iesnium_ore", Feature.ORE, new OreConfiguration(MiscReplaceables.OCCULTISM_NETHER_NATURAL_IESNIUM_ORE_REPLACEABLES, MiscCommonConfigs.OCCULTISM_NETHER_NATURAL_IESNIUM_SIZE.get()));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> OCCULTISM_NETHER_IESNIUM_ORE = FeatureUtils.register("imd_occultism_nether_iesnium_ore", Feature.ORE, new OreConfiguration(MiscReplaceables.OCCULTISM_NETHER_IESNIUM_ORE_REPLACEABLES, MiscCommonConfigs.OCCULTISM_NETHER_IESNIUM_SIZE.get()));
    //Tinkers
