package com.Infinity.Nexus.MiningDimension.world.feature.minecraft;

import com.Infinity.Nexus.MiningDimension.config.MinecraftCommonConfigs;
...
public class MinecraftConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> NETHER_MAGMA_BLOCK_ORE = FeatureUtils.register("imd_nether_magma_block_ore", Feature.ORE, new OreConfiguration(MinecraftReplaceables.NETHER_MAGMA_BLOCK_ORE_REPLACEABLES, MinecraftCommonConfigs.NETHER_MAGMA_BLOCK_SIZE.get()));
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> CLAY_BLOCK = FeatureUtils.register("imd_clay_block", Feature.ORE, new OreConfiguration(MinecraftReplaceables.CLAY_BLOCK_REPLACEABLES, MinecraftCommonConfigs.CLAY_SIZE.get()));
