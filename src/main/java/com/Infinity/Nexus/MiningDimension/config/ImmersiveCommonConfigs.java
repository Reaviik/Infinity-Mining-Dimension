...
public class ImmersiveCommonConfigs {
    ...
    static {
        ...
        BAUXITE_VEINS = BUILDER.comment("Immersive").define("bauxite_veins_per_chunk", 1);
        BAUXITE_SIZE = BUILDER.comment("Immersive").define("bauxite_vein_size", 4);
        LEAD_VEINS = BUILDER.comment("Immersive").define("lead_veins_per_chunk", 1);
        LEAD_SIZE = BUILDER.comment("Immersive").define("lead_vein_size", 4);
        SILVER_VEINS = BUILDER.comment("Immersive").define("silver_veins_per_chunk", 1);
        SILVER_SIZE = BUILDER.comment("Immersive").define("silver_vein_size", 4);
        NICKEL_VEINS = BUILDER.comment("Immersive").define("nickel_veins_per_chunk", 1);
        NICKEL_SIZE = BUILDER.comment("Immersive").define("nickel_vein_size", 4);
        URANIUM_VEINS = BUILDER.comment("Immersive").define("uranium_veins_per_chunk", 1);
        URANIUM_SIZE = BUILDER.comment("Immersive").define("uranium_vein_size", 4);

        DEEPSLATE_BAUXITE_VEINS = BUILDER.comment("Immersive").define("deepslate_bauxite_veins_per_chunk", 1);
        DEEPSLATE_BAUXITE_SIZE = BUILDER.comment("Immersive").define("deepslate_bauxite_vein_size", 4);
        DEEPSLATE_LEAD_VEINS = BUILDER.comment("Immersive").define("deepslate_lead_veins_per_chunk", 1);
        DEEPSLATE_LEAD_SIZE = BUILDER.comment("Immersive").define("deepslate_lead_vein_size", 4);
        DEEPSLATE_NICKEL_VEINS = BUILDER.comment("Immersive").define("deepslate_nickel_veins_per_chunk", 1);
        DEEPSLATE_NICKEL_SIZE = BUILDER.comment("Immersive").define("deepslate_nickel_vein_size", 4);
        DEEPSLATE_SILVER_VEINS = BUILDER.comment("Immersive").define("deepslate_silver_veins_per_chunk", 1);
        DEEPSLATE_SILVER_SIZE = BUILDER.comment("Immersive").define("deepslate_silver_vein_size", 4);
        DEEPSLATE_URANIUM_VEINS = BUILDER.comment("Immersive").define("deepslate_uranium_veins_per_chunk", 1);
        DEEPSLATE_URANIUM_SIZE = BUILDER.comment("Immersive").define("deepslate_uranium_vein_size", 4);
