...
public class MiscCommonConfigs {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_SILVER_VEINS;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_SILVER_SIZE;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_DEEPSLATE_SILVER_VEINS;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_DEEPSLATE_SILVER_SIZE;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_NETHER_IESNIUM_VEINS;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_NETHER_IESNIUM_SIZE;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_NETHER_NATURAL_IESNIUM_VEINS;
    public static final ForgeConfigSpec.ConfigValue<Integer> OCCULTISM_NETHER_NATURAL_IESNIUM_SIZE;
    ...
    static {
        ...
        INFINITY_VEINS = BUILDER.comment("Misc").define("infinity_veins_per_chunk", 1);
        INFINITY_SIZE = BUILDER.comment("Misc").define("infinity_vein_size", 4);
        DEEPSLATE_INFINITY_VEINS = BUILDER.comment("Misc").define("deepslate_infinity_veins_per_chunk", 1);
        DEEPSLATE_INFINITY_SIZE = BUILDER.comment("Misc").define("deepslate_infinity_vein_size", 4);

        DARK_VEINS = BUILDER.comment("Misc").define("dark_veins_per_chunk", 1);
        DARK_SIZE = BUILDER.comment("Misc").define("dark_vein_size", 4);
        DEEPSLATE_DARK_VEINS = BUILDER.comment("Misc").define("deepslate_dark_veins_per_chunk", 1);
        DEEPSLATE_DARK_SIZE = BUILDER.comment("Misc").define("deepslate_dark_vein_size", 4);

        EXPETRIFIED_VEINS = BUILDER.comment("Misc").define("expetrified_veins_per_chunk", 1);
        EXPETRIFIED_SIZE = BUILDER.comment("Misc").define("expetrified_vein_size", 4);
        ARCANE_CRYSTAL_VEINS = BUILDER.comment("Misc").define("arcane_crystal_veins_per_chunk", 1);
        ARCANE_CRYSTAL_SIZE = BUILDER.comment("Misc").define("arcane_crystal_vein_size", 4);
        DEEPSLATE_ARCANE_CRYSTAL_VEINS = BUILDER.comment("Misc").define("deepslate_arcane_crystal_veins_per_chunk", 1);
        DEEPSLATE_ARCANE_CRYSTAL_SIZE = BUILDER.comment("Misc").define("deepslate_arcane_crystal_vein_size", 4);

        CERTUS_QUARTZ_VEINS = BUILDER.comment("Misc").define("certus_quartz_veins_per_chunk", 1);
        CERTUS_QUARTZ_SIZE = BUILDER.comment("Misc").define("certus_quartz_vein_size", 4);
        DEEPSLATE_CERTUS_QUARTZ_VEINS = BUILDER.comment("Misc").define("deepslate_certus_quartz_veins_per_chunk", 1);
        DEEPSLATE_CERTUS_QUARTZ_SIZE = BUILDER.comment("Misc").define("deepslate_certus_quartz_vein_size", 4);

        ELEMENTIUM_VEINS = BUILDER.comment("Misc").define("elementium_veins_per_chunk", 1);
        ELEMENTIUM_SIZE = BUILDER.comment("Misc").define("elementium_vein_size", 4);
        DRAGONSTONE_VEINS = BUILDER.comment("Misc").define("dragonstone_veins_per_chunk", 1);
        DRAGONSTONE_SIZE = BUILDER.comment("Misc").define("dragonstone_vein_size", 4);


        YELLORITE_VEINS = BUILDER.comment("Misc").define("uranium_veins_per_chunk", 1);
        YELLORITE_SIZE = BUILDER.comment("Misc").define("uranium_vein_size", 4);
        NETHER_BENITOIDE_VEINS = BUILDER.comment("Misc").define("nether_benitoide_veins_per_chunk", 1);
        NETHER_BENITOIDE_SIZE = BUILDER.comment("Misc").define("nether_benitoide_vein_size", 4);
        END_ANGLESITE_VEINS = BUILDER.comment("Misc").define("end_anglesite_veins_per_chunk", 1);
        END_ANGLESITE_SIZE = BUILDER.comment("Misc").define("end_anglesite_vein_size", 4);

        NETHER_COBALT_VEINS = BUILDER.comment("Misc").define("nether_cobalt_veins_per_chunk", 1);
        NETHER_COBALT_SIZE = BUILDER.comment("Misc").define("nether_cobalt_vein_size", 4);

        OCCULTISM_SILVER_VEINS = BUILDER.comment("Misc").define("nether_iesnium_veins_per_chunk", 1);
        OCCULTISM_SILVER_SIZE = BUILDER.comment("Misc").define("nether_iesnium_vein_size", 4);
        OCCULTISM_DEEPSLATE_SILVER_VEINS = BUILDER.comment("Misc").define("nether_iesnium_veins_per_chunk", 1);
        OCCULTISM_DEEPSLATE_SILVER_SIZE = BUILDER.comment("Misc").define("nether_iesnium_vein_size", 4);
        OCCULTISM_NETHER_IESNIUM_VEINS = BUILDER.comment("Misc").define("nether_iesnium_veins_per_chunk", 1);
        OCCULTISM_NETHER_IESNIUM_SIZE = BUILDER.comment("Misc").define("nether_iesnium_vein_size", 4);
        OCCULTISM_NETHER_NATURAL_IESNIUM_VEINS = BUILDER.comment("Misc").define("nether_iesnium_veins_per_chunk", 1);
        OCCULTISM_NETHER_NATURAL_IESNIUM_SIZE = BUILDER.comment("Misc").define("nether_iesnium_vein_size", 4);
