...
public class MekanismCommonConfigs {
    ...
    static {
        ...
        OSMIUM_VEINS = BUILDER.comment("Mekanism").define("osmium_veins_per_chunk", 9);
        OSMIUM_SIZE = BUILDER.comment("Mekanism").define("osmium_vein_size", 8);
        LEAD_VEINS = BUILDER.comment("Mekanism").define("lead_veins_per_chunk", 9);
        LEAD_SIZE = BUILDER.comment("Mekanism").define("lead_vein_size", 8);
        TIN_VEINS = BUILDER.comment("Mekanism").define("tin_veins_per_chunk", 9);
        TIN_SIZE = BUILDER.comment("Mekanism").define("tin_vein_size", 8);
        URANIUM_VEINS = BUILDER.comment("Mekanism").define("uranium_veins_per_chunk", 9);
        URANIUM_SIZE = BUILDER.comment("Mekanism").define("uranium_vein_size", 8);
        FLUORITE_VEINS = BUILDER.comment("Mekanism").define("fluorite_veins_per_chunk", 9);
        FLUORITE_SIZE = BUILDER.comment("Mekanism").define("fluorite_vein_size", 8);

        DEEPSLATE_OSMIUM_VEINS = BUILDER.comment("Mekanism").define("deepslate_osmium_veins_per_chunk", 9);
        DEEPSLATE_OSMIUM_SIZE = BUILDER.comment("Mekanism").define("deepslate_osmium_vein_size", 8);
        DEEPSLATE_LEAD_VEINS = BUILDER.comment("Mekanism").define("deepslate_lead_veins_per_chunk", 9);
        DEEPSLATE_LEAD_SIZE = BUILDER.comment("Mekanism").define("deepslate_lead_vein_size", 8);
        DEEPSLATE_TIN_VEINS = BUILDER.comment("Mekanism").define("deepslate_tin_veins_per_chunk", 9);
        DEEPSLATE_TIN_SIZE = BUILDER.comment("Mekanism").define("deepslate_tin_vein_size", 8);
        DEEPSLATE_URANIUM_VEINS = BUILDER.comment("Mekanism").define("deepslate_uranium_veins_per_chunk", 9);
        DEEPSLATE_URANIUM_SIZE = BUILDER.comment("Mekanism").define("deepslate_uranium_vein_size", 8);
        DEEPSLATE_FLUORITE_VEINS = BUILDER.comment("Mekanism").define("deepslate_fluorite_veins_per_chunk", 9);
        DEEPSLATE_FLUORITE_SIZE = BUILDER.comment("Mekanism").define("deepslate_fluorite_vein_size", 8);
        //----------------------------------------------//----------------------------------------------//
