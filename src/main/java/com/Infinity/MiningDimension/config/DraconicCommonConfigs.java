...
public class DraconicCommonConfigs {
    ...
    static {
        ...
        DRACONIUM_VEINS = BUILDER.comment("Draconic").define("draconium_veins_per_chunk", 9);
        DRACONIUM_SIZE = BUILDER.comment("Draconic").define("draconium_vein_size", 8);

        DEEPSLATE_DRACONIUM_VEINS = BUILDER.comment("Draconic").define("deepslate_draconium_veins_per_chunk", 9);
        DEEPSLATE_DRACONIUM_SIZE = BUILDER.comment("Draconic").define("deepslate_draconium_vein_size", 8);

        NETHER_DRACONIUM_VEINS = BUILDER.comment("Draconic").define("nether_draconium_veins_per_chunk", 1);
        NETHER_DRACONIUM_SIZE = BUILDER.comment("Draconic").define("nether_draconium_vein_size", 8);

        END_DRACONIUM_VEINS = BUILDER.comment("Draconic").define("end_draconium_veins_per_chunk", 1);
        END_DRACONIUM_SIZE = BUILDER.comment("Draconic").define("end_draconium_vein_size", 8);
